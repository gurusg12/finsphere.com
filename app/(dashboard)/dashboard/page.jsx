...
export default async function Dashboard() {
  ...
  // 🔴 Handle no user (important for Vercel build + runtime)
  if (!user) {
    redirect("/login"); // or return a message instead
  }
            ...
            <tbody>
              ...
              {recent.map(t => (
                <tr key={t._id}>
                  ...
                  <td>
                    <span className="badge bg-gray-100">{t.type}</span>
                  </td>
                  <td>
